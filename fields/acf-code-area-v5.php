...
if( !class_exists('acf_field_code_area_field') ) :


class acf_field_code_area_field extends acf_field {
  ...
  */
  ...
  function __construct( $settings ) {
    ...
    */
    ...
    $this->label = __('Code Area', 'acf-code_area_field');
    ...
    *  var message = acf._e('code_area_field', 'error');
    */

    $this->l10n = array(
      'error'	=> __('Error! Please enter a higher value', 'acf-code_area_field'),
    );
  ...
  function render_field_settings( $field ) {
    ...
    */
    ...
    acf_render_field_setting( $field, array(
      'label'			=> __('Default Value','acf-code_area_field'),
  ...
  */
  ...
  function render_field( $field ) {
    ...
    // vars
    $settings = array( 'id', 'class', 'name', 'mode', 'theme' );
    $output = '';
    ...
    $output .= '<textarea ' . acf_esc_attr( $atts ) . ' >';
    $output .= esc_textarea( $field['value'] );
    $output .= '</textarea>';
  ...
  */
  ...
  function input_admin_enqueue_scripts() {
    ...
    wp_enqueue_style('acf-input-code_area_field');
    wp_enqueue_style( 'codemirror-monokai', "{$url}assets/vendors/codemirror/theme/monokai.css" );

    // Localize the script with new data
    $localized_values = array(
      'plugins_url' => plugins_url('acf-code-area-field'),
    );
  ...
  */
  ...
  function validate_value( $valid, $value, $field, $input ){
    ...
    if( $value < $field['custom_minimum_setting'] )
    {
      $valid = __('The value is too little!','acf-code_area_field'),
    }
...
// initialize
new acf_field_code_area_field( $this->settings );
